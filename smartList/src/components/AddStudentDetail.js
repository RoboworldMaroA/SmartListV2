import React, {useState}  from 'react';
    /* useState is ided to set a value  */



    const AddStudentDetail = ({setStudentInfo}) => {
        ...
        return (
            ...
            <div className="row">
                <form className="col s12" onSubmit={() => addStudent()}>
                    ...
                    <div className="row">
                        <button className="waves-effect waves-light btn " type="submit" name="action">Add New Client</button>
